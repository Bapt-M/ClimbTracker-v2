...
export default function UserProfile() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col w-full max-w-md md:max-w-none mx-auto overflow-hidden md:overflow-visible bg-cream md:pt-16">
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto md:overflow-visible no-scrollbar pb-32 md:pb-6">
        <div className="px-6 pt-4 md:flex md:gap-8 md:items-start">

          {/* Left column — avatar, stats summary */}
          <div className="md:w-80 md:flex-shrink-0 md:sticky md:top-32 flex flex-col gap-8">
            {/* Profile Header */}
          ...
          {/* Right column — routes list, activity */}
          <div className="flex-1 min-w-0 flex flex-col gap-8 mt-8 md:mt-0">
